        ...
        return (
                <div className="ui-app">
                        ...
                        <div className="ui-app__logo">
                                <h1><span>✨Manohar Rajotiya✨</span></h1>
                        </div>
                        ...
                        <div className="ui-app__footer">
                                <div className="ui-app__footer__links">
                                        <a className="ui-app__footer__links__link link-hashnode" href="https://hashnode.com/@StaticVar18" target="_blank">
                                                <span className="link-icon"/>
                                                <span className="link-title">Hashnode</span></a>
                                        <a className="ui-app__footer__links__link link-github" href="https://github.com/Manoharjangid1818" target="_blank">
                                                <span className="link-icon"/>
                                                <span className="link-title">GitHub</span></a>
                                        <a className="ui-app__footer__links__link link-linkedin" href="https://www.linkedin.com/in/manoharjangid1818" target="_blank">
                                                <span className="link-icon"/>
                                                <span className="link-title">LinkedIn</span></a>
                                </div>

                                <div className="ui-app__footer__source-code">
                                        <a className="ui-app__footer__source-code__link" href="https://github.com/Manoharjangid1818" target="_blank">(Source Code)</a>
                                </div>
                        </div>
                </div>
        );
